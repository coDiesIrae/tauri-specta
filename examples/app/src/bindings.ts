         ...
         export const commands = {
                ...
                hello_world: command<{myName: string}, string, never>("plugin:tauri-specta|hello_world")
                ,

                goodbye_world: command<{}, string, never>("plugin:tauri-specta|goodbye_world")
                ,

                has_error: command<{}, string, number>("plugin:tauri-specta|has_error")
                ,

                result_struct: command<{}, MyStruct, null>("plugin:tauri-specta|result_struct")
                ,

                my_struct: command<{}, MyStruct, never>("plugin:tauri-specta|my_struct")
                ,

                generic_struct: command<{}, { some_field: string }, null>("plugin:tauri-specta|generic_struct")
                ,
